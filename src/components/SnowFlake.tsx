...
import ConfettiImage from '../assets/snowflake.png';
...
import type { ConfettiItems, SnowflakeConfettiProps } from '../utils/types';

const SnowFlakeConfetti = ({
...
export default SnowFlakeConfetti;
